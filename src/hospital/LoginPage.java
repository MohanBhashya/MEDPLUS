...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // Create a new thread for database access
        Thread dbAccessThread = new Thread(() -> {
            try {
                Class.forName("com.mysql.jdbc.Driver");
                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/hms", "root", "Sl@372005");
